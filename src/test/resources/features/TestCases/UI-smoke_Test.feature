Feature: Appium Testing
	...
	Ecom App Login valid Credential

	@UI-smoke
	Scenario: smoke - As a User I should be able to login with valid credentials
		...
		Then User Enters value "Shiba#55" in  "Text Field" "Password" having "id" "com.studiobluelime.ecommerceapp:id/et_login_password"
