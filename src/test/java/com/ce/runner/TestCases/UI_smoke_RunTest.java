...
public class UI_smoke_RunTest extends RunnerBase{
    private static final Logger Log = LogManager.getLogger(UI_smoke_RunTest.class);
    public static void main(String[] args) {
        ...
        // Run your tests
        core.run(UI_smoke_RunTest.class);
    }
}
